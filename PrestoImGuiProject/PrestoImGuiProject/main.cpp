...
int main(int, char**)
{
    ...
    int pos_x = (mode->width - WINDOW_WIDTH) / 2;
    int pos_y = (mode->height - WINDOW_HEIGHT) / 2;
    ...
    glfwSwapInterval(1); // Enable vsync // disable vsync for benchmarking
